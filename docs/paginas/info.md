...
**Nada se publica sin revisión humana.** Cada texto y cada imagen pasan por un editor antes de salir. El sistema está construido con puntos de control que no se pueden saltear: si un editor no aprueba, la edición no avanza.

Lo decimos con todas las letras porque nos parece que corresponde. Usamos IA como herramienta, no como reemplazo del criterio. Si un día encontrás un error, escribinos y lo corregimos.
...
La Puta Política es un proyecto independiente, sin financiamiento de partidos, empresas ni organizaciones.

Escribinos a **hola@laputapolitica.com**. Leemos todo: correcciones, críticas, ideas, propuestas.
...
La Puta Política es un proyecto de Marcos Buzolich. Ciudad Autónoma de Buenos Aires, Argentina.
